...
heatmap.get_figure().savefig('C:\Users\hurri\Desktop\SWENG\heatmap6.png', bbox_inches='tight') #I found that bbox_inches = 'tight' helps your picture not get cut off if it's too big